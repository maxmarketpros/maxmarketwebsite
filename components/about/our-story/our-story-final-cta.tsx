...
export function OurStoryFinalCta() {
  return (
    <section
      aria-labelledby="our-story-final-cta-heading"
      className="relative"
    >
      <div className="section-container pb-20 sm:pb-24 lg:pb-28 pt-4 sm:pt-6">
        ...
        >
          ...
          >
            ...
            <rect width="100%" height="100%" fill="url(#our-story-cta-dots)" />
          </svg>
          ...
          <div className="relative text-center px-6 sm:px-10 lg:px-14 py-14 sm:py-16 lg:py-20 max-w-[820px] mx-auto">
            ...
            >
              A senior strategist &mdash; not a sales rep &mdash; reviews your
              business in a 30-minute call. You leave with a clearer plan whether
              you hire us or not.
            </p>
