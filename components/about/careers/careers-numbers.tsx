const stats = [
  { value: "Irvine, CA", label: "Headquarters" },
  { value: "5+", label: "Years independent" },
  { value: "1,000+", label: "Clients served" },
  { value: "100%", label: "In-office team" },
]

export function CareersNumbers() {
  return (
    <section
      aria-label="Max Market Pros careers by the numbers"
    ...
    >
      ...
      >
        ...
        <rect width="100%" height="100%" fill="url(#careers-numbers-dots)" />
      </svg>
