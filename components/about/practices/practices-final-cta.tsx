...
export function PracticesFinalCta() {
  return (
    <section
      aria-labelledby="practices-final-cta-heading"
      className="relative"
    >
      <div className="section-container pb-20 sm:pb-24 lg:pb-28 pt-4 sm:pt-6">
        ...
        >
          ...
          >
            ...
            <rect width="100%" height="100%" fill="url(#practices-cta-dots)" />
          </svg>
          ...
          <div className="relative text-center px-6 sm:px-10 lg:px-14 py-14 sm:py-16 lg:py-20 max-w-[820px] mx-auto">
            ...
            >
              A senior strategist reviews your current marketing, names the top
              three things to fix, and shows you exactly how we&rsquo;d run it.
              30 minutes. No sales rep.
            </p>
            ...
            >
              ...
              <a href="/about/our-story" className="font-semibold hover:underline" style={{ color: "#fff" }}>
                Our story
              </a>
              <a href="/about/team" className="font-semibold hover:underline" style={{ color: "#fff" }}>
                Team
              </a>
              <a href="/resources/case-studies" className="font-semibold hover:underline" style={{ color: "#fff" }}>
                Case studies
              </a>
              <a href="/about/testimonials" className="font-semibold hover:underline" style={{ color: "#fff" }}>
                Testimonials
              </a>
              <a href="/plans" className="font-semibold hover:underline" style={{ color: "#fff" }}>
                See all plans &rarr;
              </a>
            </div>
          </div>
