...
export function SquarespaceFinalCta() {
  return (
    <section
      aria-labelledby="squarespace-final-cta-heading"
      className="relative"
    >
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg, #0B0B0B 0%, #11203F 55%, #1677FF 130%)",
        ...
        >
          ...
          >
            ...
            <rect width="100%" height="100%" fill="url(#squarespace-cta-dots)" />
          </svg>
          ...
          <div className="relative text-center px-6 sm:px-10 lg:px-14 py-14 sm:py-16 lg:py-20 max-w-[820px] mx-auto">
            ...
            >
              A senior strategist hand-audits your existing Squarespace site (or
              your competitors) — design, SEO, schema, performance, and
              conversion. You get a prioritized fix list, with or without us.
            </p>
