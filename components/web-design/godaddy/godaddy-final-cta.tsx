...
export function GoDaddyFinalCta() {
  return (
    <section
      aria-labelledby="godaddy-final-cta-heading"
      className="relative"
    >
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg, #0B132B 0%, #11203F 50%, #1BDBDB 140%)",
        ...
        >
          ...
          >
            ...
            <rect width="100%" height="100%" fill="url(#godaddy-cta-dots)" />
          </svg>
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(27,219,219,0.45) 0%, transparent 65%)",
            }}
          />
          <div
            aria-hidden
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(22,119,255,0.30) 0%, transparent 65%)",
            }}
          />
          ...
          <div className="relative text-center px-6 sm:px-10 lg:px-14 py-14 sm:py-16 lg:py-20 max-w-[820px] mx-auto">
            ...
            >
              A senior strategist hand-audits your existing GoDaddy site —
              design, on-page SEO, schema, Core Web Vitals, and conversion. You
              get a prioritized fix list, with or without us.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <a
                ...
                style={{
                  background:
                    "linear-gradient(180deg, #fff 0%, #E6FBFB 100%)",
                  color: "#0B132B",
                  boxShadow:
                    "0 1px 2px rgba(0,0,0,0.18), 0 8px 24px rgba(27,219,219,0.40)",
                }}
              >
