...
export function WordpressFinalCta() {
  return (
    <section
      aria-labelledby="wordpress-final-cta-heading"
      className="relative"
    >
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        <div
          ...
          style={{
            ...
            background: `linear-gradient(135deg, #0B132B 0%, #0E2A3F 50%, ${WP_BLUE} 130%)`,
        ...
        >
          ...
          >
            ...
            <rect width="100%" height="100%" fill="url(#wordpress-cta-dots)" />
          </svg>
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(0,116,156,0.40) 0%, transparent 65%)",
            }}
          />
          ...
          <div className="relative text-center px-6 sm:px-10 lg:px-14 py-14 sm:py-16 lg:py-20 max-w-[820px] mx-auto">
            ...
            >
              A senior strategist hand-audits your existing WordPress site (or
              your competitors) — design, plugin stack, schema, performance,
              and security. You get a prioritized fix list, with or without us.
            </p>
