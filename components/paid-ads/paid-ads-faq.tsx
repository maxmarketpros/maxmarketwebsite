...
import { paidAdsFaqs } from "./paid-ads-faq-data"

export function PaidAdsFaq() {
  const [openIdx, setOpenIdx] = useState<number | null>(0)

  return (
    <section
      id="paid-ads-faq"
      aria-labelledby="paid-ads-faq-heading"
      className="relative"
    >
