...
import { instagramAdsFaqs } from "./instagram-ads-faq-data"
...
export function InstagramAdsFaq() {
  const [openIdx, setOpenIdx] = useState<number | null>(0)

  return (
    <section
      id="instagram-ads-faq"
      aria-labelledby="instagram-ads-faq-heading"
      className="relative"
    >
      ...
      <div className="section-container section-y relative z-10">
        <SectionHeader
          pill="Questions"
          heading={
            <span id="instagram-ads-faq-heading">
          ...
          paragraph="Everything service businesses ask before hiring us &mdash; pricing, minimum spend, account ownership, creative ownership, whitelisting, contract terms, and what happens if you ever leave."
        />
        ...
        >
                  ...
                  >
                    <span
                      ...
                      style={{
                        background: isOpen
                          ? IG_GRADIENT_CSS
                          : "rgba(214,41,118,0.10)",
                        color: isOpen ? "#fff" : "#B83265",
                        transform: isOpen ? "rotate(45deg)" : "rotate(0deg)",
                        boxShadow: isOpen
                          ? "0 4px 10px rgba(214,41,118,0.32)"
                          : "none",
                      }}
                    >
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 text-center">
            <span className="text-[15.5px]" style={{ color: "var(--muted)" }}>
              Still have questions about Instagram Ads management?
            </span>
            <SecondaryButton asLink href="#contact">
              Talk to an Instagram Ads strategist
            </SecondaryButton>
          </div>
        </div>
      </div>
...
export function InstagramAdsFaqJsonLd() {
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: instagramAdsFaqs.map((f) => ({
      "@type": "Question",
      name: stripHtml(f.q),
