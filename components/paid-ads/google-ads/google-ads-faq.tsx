...
import { googleAdsFaqs } from "./google-ads-faq-data"
    ...
    >
      ...
      <div className="section-container section-y relative z-10">
        <SectionHeader
          pill="Questions"
          heading={
            <span id="google-ads-faq-heading">
          ...
          paragraph="Everything service businesses ask before hiring us for Google Ads management &mdash; pricing, minimum spend, account ownership, contract terms, and what happens if you ever leave."
        />
        ...
        >
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 text-center">
            <span className="text-[15.5px]" style={{ color: "var(--muted)" }}>
              Still have questions about Google Ads management?
            </span>
...
export function GoogleAdsFaqJsonLd() {
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: googleAdsFaqs.map((f) => ({
      "@type": "Question",
      name: stripHtml(f.q),
