...
const capabilities = [
  "Local Services Ads + Google Guaranteed verification",
  "Negative-keyword sculpting weekly",
  "Call tracking + offline conversion imports",
  "Quality Score auditing + ad-copy rewriting",
  "Service-area geo bid strategy",
  "Weekly performance optimization",
  "Landing page conversion review",
  "Transparent flat-fee pricing (no % of spend)",
]

const columns: Column[] = [
  {
    name: "DIY",
    subtitle: "You + Google's wizard",
    cost: "Your time",
    costNote: "10–15 hrs/wk",
    Icon: User,
    capabilities: ["no", "no", "partial", "no", "no", "no", "no", "yes"],
  },
  {
    name: "In-House Specialist",
    subtitle: "1 PPC manager",
    cost: "$75K+/yr",
    costNote: "+ benefits",
    Icon: Users,
    capabilities: ["partial", "yes", "yes", "yes", "partial", "yes", "partial", "partial"],
  },
  {
    name: "Freelancer",
    ...
    Icon: Briefcase,
    capabilities: ["no", "partial", "partial", "partial", "no", "partial", "no", "partial"],
  },
  {
    name: "Other Agency",
    ...
    costNote: "+ setup fees",
    Icon: Building2,
    capabilities: ["partial", "yes", "partial", "yes", "partial", "partial", "no", "no"],
  },
  {
...
export function GoogleAdsVsAlternatives() {
  return (
    <section
      id="google-ads-vs"
      aria-labelledby="google-ads-vs-heading"
      className="relative"
    >
      ...
      <div className="section-container section-y relative z-10">
        <SectionHeader
          ...
          heading={
            <span id="google-ads-vs-heading">
              DIY, freelancer, or{" "}
              <span className="whitespace-nowrap">
                <span className="accent-underline">agency</span>?
              </span>
            </span>
          }
          paragraph="Most service businesses cycle through DIY, a freelancer, and an in-house specialist before they land on a real Google Ads agency. Here&rsquo;s the honest comparison &mdash; including where the cheap options actually beat us."
        />
        ...
        >
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 text-center">
            <span
              ...
              style={{ color: "var(--muted)" }}
            >
              Tired of paying a percentage of spend to learn nothing?
            </span>
            <a
              href="#contact"
            ...
            >
              Switch to a flat-fee Google Ads agency
              <ArrowRight
