...
import { HardHat, Home, Store, UtensilsCrossed, HeartPulse, Car, Layers, ArrowDown } from "lucide-react"
import { Pill } from "@/components/ui/pill"
import { PrimaryButton } from "@/components/ui/primary-button"
import { SecondaryButton } from "@/components/ui/secondary-button"

const shortcuts = [
  { Icon: HardHat,         label: "Contractors",    href: "/industries/contractors",   color: "#EF4444" },
  { Icon: Home,            label: "Home Services",  href: "/industries/home-services", color: "#14B8A6" },
  { Icon: Store,           label: "Local Service",  href: "/industries/local-service", color: "#1677FF" },
  { Icon: UtensilsCrossed, label: "Restaurants",    href: "/industries/restaurants",   color: "#EC4899" },
  { Icon: HeartPulse,      label: "Medical",        href: "/industries/medical",       color: "#22C55E" },
  { Icon: Car,             label: "Automotive",     href: "/industries/automotive",    color: "#F59E0B" },
]

export function HubHero() {
  return (
    <section aria-labelledby="hub-hero-heading" className="relative overflow-hidden">
      {/* Ambient auras (wider spread for a centered hero) */}
      ...
      <div className="section-container relative z-10 pt-16 sm:pt-20 lg:pt-28 pb-12 sm:pb-16 lg:pb-20">
        <div className="max-w-[880px] mx-auto text-center" style={{ animation: "fadeInUp 0.8s ease-out both" }}>
          ...
          <h1
            id="hub-hero-heading"
            className="mt-6 text-[42px] xs:text-[48px] sm:text-[58px] lg:text-[72px] font-bold leading-[1.05] tracking-[-0.025em] sm:tracking-[-0.03em] text-balance"
            style={{ color: "var(--ink)" }}
          >
            One marketing stack. Tuned to{" "}
            <span className="whitespace-nowrap">
              your <span className="accent-underline">industry</span>.
            </span>
          </h1>

          <p className="mt-6 text-[17px] sm:text-[19px] leading-[1.65] max-w-[680px] mx-auto" style={{ color: "var(--muted)" }}>
            Every vertical has its own search behavior, buying cycle, and review dynamics. We ship the same five-layer stack to every client &mdash; then tune each layer to the way your industry actually books work.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            <SecondaryButton asLink href="#hub-featured">
