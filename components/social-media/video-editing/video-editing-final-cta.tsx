...
const secondaryCtas = [
  {
    Icon: PlayCircle,
    label: "Browse the video editing portfolio",
    sub: "Before/after Reels by industry",
    href: "#video-editing-before-after",
    accent: "#EC4899",
  },
  {
    Icon: Eye,
    label: "Compare video editing packages",
    sub: "8, 16, or 32 edits per month",
    href: "/#pricing",
    accent: "#22C55E",
  },
  {
    Icon: Scissors,
    label: "Talk to a senior video editor",
    sub: "25-min creative + scope call",
    href: "#contact",
    accent: "#1677FF",
  },
]
...
export function VideoEditingFinalCta() {
  return (
    <section
      aria-labelledby="video-editing-final-cta-heading"
      className="relative"
    >
        ...
        >
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-12 px-6 sm:px-10 lg:px-14 py-14 sm:py-16 lg:py-20">
            ...
            <div>
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 10px 24px rgba(22,119,255,0.30), inset 0 1px 0 rgba(255,255,255,0.20)",
                  }}
                >
                  <Scissors
                    className="w-8 h-8"
              ...
              >
                A senior video editor will scope your monthly video editing
                plan in 25 minutes — output volume, platforms, brand-style guide,
                and a fixed monthly fee. Real plan, zero pressure.
              </p>
