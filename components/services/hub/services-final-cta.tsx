...
export function ServicesFinalCta() {
  return (
    <section id="services-final-cta" aria-labelledby="services-final-cta-heading" className="relative">
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        <div
          className="relative overflow-hidden text-center"
          style={{
            borderRadius: "var(--radius-xl)",
            background: "linear-gradient(135deg, #0B132B 0%, #1677FF 50%, #74D3FF 100%)",
            boxShadow: "0 10px 30px rgba(22,119,255,0.28), 0 30px 80px rgba(11,19,43,0.25)",
          }}
        >
          {/* Four-pillar ribbon stripe (one color per pillar) */}
          <div aria-hidden className="absolute top-0 left-0 right-0 h-[6px] flex">
            {["#22C55E", "#1677FF", "#EC4899", "#F59E0B"].map((c) => (
          ...
          <div className="relative px-6 sm:px-10 py-16 sm:py-20 lg:py-24">
            ...
            >
              ...
              <span className="whitespace-nowrap">
                We&rsquo;ll bring <span className="accent-underline">the stack</span>.
              </span>
            </h2>
            <p
            ...
            >
              Book a free 30-minute strategy call. We&rsquo;ll audit your current marketing, tell you which 2&ndash;3 services will move your number fastest, and quote it on the spot &mdash; bundled or à la carte, your choice.
            </p>
