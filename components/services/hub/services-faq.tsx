...
import { servicesFaqs } from "./services-faq-data"

export function ServicesFaq() {
  const [openIdx, setOpenIdx] = useState<number | null>(0)

  return (
    <section aria-labelledby="services-faq-heading" className="relative">
      <div className="section-container section-y">
        <SectionHeader
          pill="FAQ"
          heading={
            <span id="services-faq-heading">
              Common questions,{" "}
              <span className="accent-underline">
                answered <span className="whitespace-nowrap">straight.</span>
              </span>
            </span>
          }
          paragraph="No fluff, no jargon, no over-promising. If you have a question that isn't here, just ask."
        />
