...
export function SignatureFinalCta() {
  return (
    <section
      id="signature-final-cta"
      aria-labelledby="signature-final-cta-heading"
      className="relative"
    >
      <div className="section-container pb-20 sm:pb-24 lg:pb-28 pt-4">
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg, #0B132B 0%, #7C3AED 35%, #EC4899 65%, #F59E0B 100%)",
            boxShadow:
              "0 10px 30px rgba(236,72,153,0.32), 0 30px 80px rgba(11,19,43,0.25)",
          }}
        >
          ...
          <div
            ...
            style={{
              background: "radial-gradient(circle, rgba(244,114,182,0.36) 0%, transparent 60%)",
            }}
          />
          <div
            aria-hidden
          ...
          <div className="relative px-6 sm:px-10 py-16 sm:py-20 lg:py-24">
            ...
            <h2
              id="signature-final-cta-heading"
            ...
            >
              ...
              <span className="whitespace-nowrap">
                <span className="accent-underline">for good</span>?
              </span>
            </h2>
            <p
              className="mt-5 text-[17px] sm:text-[19px] leading-[1.6] max-w-[760px] mx-auto"
              style={{ color: "rgba(255,255,255,0.95)" }}
            >
              26 features. 5 pillars. A dedicated strategy lead, designer, video producer, and ads specialist on your team — every month. Let&rsquo;s make sure Signature is the right fit on the first call.
            </p>
