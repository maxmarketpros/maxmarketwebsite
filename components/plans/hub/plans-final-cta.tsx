...
export function PlansFinalCta() {
  return (
    <section id="plans-final-cta" aria-labelledby="plans-final-cta-heading" className="relative">
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        ...
        >
          {/* Four-tier ribbon stripe (one color per plan) */}
          ...
          <div className="relative px-6 sm:px-10 py-16 sm:py-20 lg:py-24">
            ...
            >
              ...
              <span className="whitespace-nowrap">
                <span className="accent-underline">fits</span>?
              </span>
            </h2>
            <p
            ...
            >
              We&rsquo;ll help you choose the right package based on your business, market, services, and growth goals &mdash; in a free 30-minute call.
            </p>
