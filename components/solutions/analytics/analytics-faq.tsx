...
import { analyticsFaqs } from "./analytics-faq-data"

export function AnalyticsFaq() {
  const [openIdx, setOpenIdx] = useState<number | null>(0)

  return (
    <section aria-labelledby="analytics-faq-heading" className="relative">
      <div className="section-container section-y">
        <SectionHeader
          pill="FAQ"
          heading={
            <span id="analytics-faq-heading">
              Analytics,{" "}
              <span className="accent-underline">
                actually <span className="whitespace-nowrap">useful.</span>
              </span>
            </span>
          }
          paragraph="The questions service-business owners ask when they're done with vanity metrics and want real answers."
        />
        ...
        <div className="mt-12 max-w-[820px] mx-auto" style={{ animation: "fadeInUp 0.7s ease-out both" }}>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 text-center">
            <span className="text-[15.5px]" style={{ color: "var(--muted)" }}>Want a free analytics audit?</span>
            <SecondaryButton asLink href="#contact">Request a free audit</SecondaryButton>
          </div>
        </div>
      </div>
    </section>
