...
export function PaymentsFinalCta() {
  return (
    <section aria-labelledby="payments-final-cta-heading" className="relative">
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        <div
          className="relative overflow-hidden text-center"
          style={{
            borderRadius: "var(--radius-xl)",
            background: "linear-gradient(135deg, #16A34A 0%, #22C55E 45%, #2B8AFF 100%)",
            boxShadow: "0 10px 30px rgba(34,197,94,0.25), 0 30px 80px rgba(22,119,255,0.22)",
          }}
        >
          ...
          <div className="relative px-6 sm:px-10 py-16 sm:py-20 lg:py-24">
            <img src={icons8Url("9fGIxsOgPawB", 256)} alt="Paid invoice illustration" width={110} height={110} className="mx-auto w-[96px] h-[96px] sm:w-[110px] sm:h-[110px] object-contain drop-shadow-[0_16px_32px_rgba(11,19,43,0.25)]" />

            <h2 id="payments-final-cta-heading" className="mt-6 text-[32px] sm:text-[44px] lg:text-[52px] font-bold leading-[1.05] tracking-[-0.025em] text-balance text-white">
              Get paid faster. Starting{" "}
              <span className="whitespace-nowrap">today.</span>
            </h2>
            <p className="mt-5 text-[17px] sm:text-[19px] leading-[1.6] max-w-[620px] mx-auto" style={{ color: "rgba(255,255,255,0.88)" }}>
              Book a free 30-minute payments audit. We'll show you exactly how to shave days off your collection cycle and wire invoices straight into your CRM.
            </p>

            <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
              <a href="#contact" className="inline-flex items-center justify-center gap-1.5 px-8 py-3.5 rounded-[var(--radius-sm)] font-semibold text-[17px] bg-white transition-all duration-200 hover:translate-y-[-1px] shadow-[0_1px_2px_rgba(17,35,68,0.1),0_8px_24px_rgba(11,19,43,0.18)]" style={{ color: "#16A34A" }}>
                Book a free payments audit
              </a>
