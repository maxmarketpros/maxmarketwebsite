...
export function EmailMarketingFinalCta() {
  return (
    <section aria-labelledby="email-marketing-final-cta-heading" className="relative">
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        ...
        >
          <div aria-hidden className="pointer-events-none absolute top-[-20%] left-[-10%] w-[400px] h-[400px] rounded-full" style={{ background: "radial-gradient(circle, rgba(255,255,255,0.25) 0%, transparent 60%)" }} />
          <div aria-hidden className="pointer-events-none absolute bottom-[-30%] right-[-10%] w-[500px] h-[500px] rounded-full" style={{ background: "radial-gradient(circle, rgba(11,19,43,0.25) 0%, transparent 60%)" }} />
          <div className="absolute inset-0 noise-overlay" />

          <div className="relative px-6 sm:px-10 py-16 sm:py-20 lg:py-24">
            <img src={icons8Url("71474", 256)} alt="Email illustrating a sent campaign" width={110} height={110} className="mx-auto w-[96px] h-[96px] sm:w-[110px] sm:h-[110px] object-contain drop-shadow-[0_16px_32px_rgba(11,19,43,0.25)]" />

            <h2 id="email-marketing-final-cta-heading" className="mt-6 text-[32px] sm:text-[44px] lg:text-[52px] font-bold leading-[1.05] tracking-[-0.025em] text-balance text-white">
              Every email{" "}
            ...
            <p className="mt-5 text-[17px] sm:text-[19px] leading-[1.6] max-w-[620px] mx-auto" style={{ color: "rgba(255,255,255,0.88)" }}>
              Book a free 30-minute email audit. We'll review your current list, deliverability, and automation setup — and show you the highest-ROI sequence to launch first.
            </p>
