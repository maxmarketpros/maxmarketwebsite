...
import { leadGenFaqs } from "./lead-gen-faq-data"

export function LeadGenFaq() {
  const [openIdx, setOpenIdx] = useState<number | null>(0)

  return (
    <section aria-labelledby="lead-gen-faq-heading" className="relative">
      <div className="section-container section-y">
        <SectionHeader
          pill="FAQ"
          heading={
            <span id="lead-gen-faq-heading">
              Lead management,{" "}
          ...
          paragraph="Common questions from service-business owners sizing up a lead system. If yours isn't listed, just ask."
        />
