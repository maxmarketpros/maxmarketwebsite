...
export function LeadGenFinalCta() {
  return (
    <section
      aria-labelledby="lead-gen-final-cta-heading"
      className="relative"
    >
        ...
        >
          ...
          <div className="relative px-6 sm:px-10 py-16 sm:py-20 lg:py-24">
            <img
              ...
              alt="Rocket illustrating growing pipeline"
              width={110}
              height={110}
            ...
            >
              Book a free 30-minute lead-flow audit. We'll map your current
              funnel, spot where leads leak, and show you exactly what a tuned
