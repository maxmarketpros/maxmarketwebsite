...
export function CalendarFinalCta() {
  return (
    <section aria-labelledby="calendar-final-cta-heading" className="relative">
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        ...
        >
          ...
          <div
            ...
            style={{ background: "radial-gradient(circle, rgba(11,19,43,0.25) 0%, transparent 60%)" }}
          />
          <div className="absolute inset-0 noise-overlay" />

          <div className="relative px-6 sm:px-10 py-16 sm:py-20 lg:py-24">
            <img
              src={icons8Url("CFTDddtQhvPh", 256)}
              alt="Calendar illustrating automated booking"
              width={110}
              height={110}
            ...
            <p className="mt-5 text-[17px] sm:text-[19px] leading-[1.6] max-w-[620px] mx-auto" style={{ color: "rgba(255,255,255,0.88)" }}>
              Book a free 30-minute call and we'll show you exactly how to set up round-robin scheduling, reminders, and deposit-on-booking for your business.
            </p>
            ...
            <div className="mt-10 pt-8 border-t" style={{ borderColor: "rgba(255,255,255,0.18)" }}>
              <div className="text-[12.5px] font-semibold uppercase tracking-[0.1em] mb-4" style={{ color: "rgba(255,255,255,0.7)" }}>
                Also explore
              </div>
