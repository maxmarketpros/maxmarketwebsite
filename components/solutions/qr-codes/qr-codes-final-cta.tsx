...
export function QRCodesFinalCta() {
  return (
    <section aria-labelledby="qr-codes-final-cta-heading" className="relative">
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        ...
        >
          ...
          <div className="relative px-6 sm:px-10 py-16 sm:py-20 lg:py-24">
            <img src={icons8Url("RzakrK96dC5U", 256)} alt="QR code illustration" width={110} height={110} className="mx-auto w-[96px] h-[96px] sm:w-[110px] sm:h-[110px] object-contain drop-shadow-[0_16px_32px_rgba(11,19,43,0.25)]" />

            <h2 id="qr-codes-final-cta-heading" className="mt-6 text-[32px] sm:text-[44px] lg:text-[52px] font-bold leading-[1.05] tracking-[-0.025em] text-balance text-white">
              Track every scan. Convert every{" "}
            ...
            <p className="mt-5 text-[17px] sm:text-[19px] leading-[1.6] max-w-[620px] mx-auto" style={{ color: "rgba(255,255,255,0.88)" }}>
              Book a free 15-minute call. We'll design one branded QR code for your business — on us — so you can see the scan analytics in action.
            </p>
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
              ...
              <a href="/plans/a-la-carte" className="inline-flex items-center justify-center gap-1.5 px-6 py-3 rounded-[var(--radius-sm)] font-semibold text-[15px] text-white border-2 hover:bg-white/10 transition-colors" style={{ borderColor: "rgba(255,255,255,0.35)" }}>
