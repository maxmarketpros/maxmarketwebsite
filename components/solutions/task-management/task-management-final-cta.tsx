...
const relatedLinks = [
  ...
  { href: "/solutions/email-marketing", label: "Email Marketing" },
  { href: "/solutions/ai-agents", label: "AI Customer Service" },
  { href: "/services/social-media", label: "Social Media" },
]

export function TaskManagementFinalCta() {
  return (
    <section aria-labelledby="task-mgmt-final-cta-heading" className="relative">
      <div className="section-container pb-20 sm:pb-24 lg:pb-28">
        ...
        >
          ...
          <div className="relative px-6 sm:px-10 py-16 sm:py-20 lg:py-24">
            <img src={icons8Url("12817", 256)} alt="Workflow gears illustration" width={110} height={110} className="mx-auto w-[96px] h-[96px] sm:w-[110px] sm:h-[110px] object-contain drop-shadow-[0_16px_32px_rgba(11,19,43,0.25)]" />

            <h2 id="task-mgmt-final-cta-heading" className="mt-6 text-[32px] sm:text-[44px] lg:text-[52px] font-bold leading-[1.05] tracking-[-0.025em] text-balance text-white">
              Turn the busywork into{" "}
              <span className="whitespace-nowrap">background noise.</span>
            </h2>
            <p className="mt-5 text-[17px] sm:text-[19px] leading-[1.6] max-w-[620px] mx-auto" style={{ color: "rgba(255,255,255,0.88)" }}>
              Book a free workflow audit. We'll map your current manual steps and show you exactly which 3 to automate first for the biggest time savings.
            </p>
