...
import { backlinkFaqs } from "./backlinks-faq-data"

function stripHtml(html: string) {
  return html.replace(/<[^>]+>/g, "")
}

export function BacklinksFaq() {
  const [openIdx, setOpenIdx] = useState<number | null>(0)

  return (
    <section
      id="backlinks-faq"
      aria-labelledby="backlinks-faq-heading"
      className="relative"
    >
      ...
      <div className="section-container section-y relative z-10">
        <SectionHeader
          pill="Backlink & directory FAQ"
          heading={
            <span id="backlinks-faq-heading">
          ...
          paragraph="The most common questions we get from businesses researching where to buy backlinks and directory submissions — safety, timelines, what we won’t do, and how it compounds with the rest of your SEO."
        />
...
export function BacklinksFaqJsonLd() {
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: backlinkFaqs.map((f) => ({
      "@type": "Question",
      name: f.q,
