...
const routes: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/resources/blog/irvine-med-spa-seo-map-pack", priority: 0.7, changeFrequency: "monthly" },
  { path: "/resources/blog/dental-seo-irvine-map-pack", priority: 0.7, changeFrequency: "monthly" },
  { path: "/resources/blog/restaurant-seo-irvine-uci-spectrum", priority: 0.7, changeFrequency: "monthly" },
  { path: "/resources/blog/bilingual-local-seo-irvine", priority: 0.7, changeFrequency: "monthly" },
  { path: "/resources/blog/b2b-saas-seo-irvine-spectrum", priority: 0.7, changeFrequency: "monthly" },
  { path: "/resources/blog/best-digital-marketing-agencies-irvine", priority: 0.8, changeFrequency: "monthly" },
